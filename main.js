...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    selectHTML.addEventListener('change', function() {
        ...
        switch (theme) {
            case 'moon-theme':
                document.body.style.backgroundImage = 'linear-gradient(to bottom, rgb(34, 0, 44),rgb(0, 5, 46))';
                break;
            case 'lime-theme':
                document.body.style.backgroundImage = 'linear-gradient(to bottom, rgb(24, 66, 49),rgb(68, 201, 101))';
                break;
            case 'cherry-theme':
                document.body.style.backgroundImage = 'linear-gradient(to bottom, rgb(71, 19, 19),rgb(199, 0, 60))';
                break;
            case 'dark-theme':
                document.body.style.backgroundImage = 'linear-gradient(to bottom, rgb(10, 10, 10),rgb(41, 41, 41))';
                break;
            default:
                document.body.style.backgroundImage = 'linear-gradient(to bottom, rgb(10, 10, 10),rgb(41, 41, 41))';
                break;
